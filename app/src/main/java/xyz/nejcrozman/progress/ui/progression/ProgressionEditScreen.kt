    ...
    Scaffold(topBar = {
        ...
        content = { paddingScaffold ->
            Column(
                ...
                /*OutlinedTextField(
                    value = uiState.value.progressionDetails.d,
                    modifier = Modifier
                        .padding(8.dp)
                        .fillMaxWidth(),
                ...
                Button(modifier = Modifier.padding(paddingValues = PaddingValues(top = 20.dp)),
                    ...
                    onClick = {
                        coroutineScope.launch {
                            ...
                            navController.popBackStack(route = "${Destinations.ProgressionList.route}/${uiState.value.progressionDetails.FK_type_id}", inclusive = false)
                        }
                    }) {
                    Text(text = "UPDATE")
                }
